...
get_os_info(){
    IP=$( ip addr | egrep -o '[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}' | egrep -v "^10\.|^127\.|^255\.|^0\." | head -n 1 )
...
preinstall_l2tp(){
    ...
    read -p "(Default PSK: aliyun.com):" mypsk
    [ -z ${mypsk} ] && mypsk="aliyun.com"

    echo "Please enter Username:"
    read -p "(Default Username: aliyun):" username
    [ -z ${username} ] && username="aliyun"
